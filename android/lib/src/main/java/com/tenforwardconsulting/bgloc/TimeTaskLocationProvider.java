...
public class TimeTaskLocationProvider extends AbstractLocationProvider implements LocationListener {
    ...
    public void startRecording() {
        ...
        new Thread(new Runnable(){
            ...
            public void run() {//可以在该线程中做需要处理的事
                ...
                log.debug("Location Test provider={} lat={} lon={} acy={} v={}m/s time={}", location.getProvider(), location.getLatitude(), location.getLongitude(), location.getAccuracy(), location.getSpeed(), location.getTime());
    ...
    private BroadcastReceiver timerUpdateReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            log.debug("Timer location update: " + new Date().toString());
